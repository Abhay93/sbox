...
$sent=$un."_sent";
include("connect.php");
$result = mysql_query("select SQL_CALC_FOUND_ROWS * from draft where sender='$un' order by id desc limit 10");
...
$("#nomails").hide()
$("#container").show()
$('#draftcntnt').bind('scroll',function () 
{
...
$.ajax({
type: "POST",
url: "fetchdraftdata.php",
data:data,
success: function(res) 
{
$("#draftcntnt").append(res);
console.log(res);
}
});
}
